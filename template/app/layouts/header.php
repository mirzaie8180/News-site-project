            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-left no-padding">
                        <ul>
                            <a href="https://www.instagram.com/mirzaie8180" target="blank"><i class="fa fa-instagram"></i></a>
                            <a href="https://github.com/mirzaie8180" target="blank"><i class="fa fa-github"></i></a>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
                        <ul>
                            <li><a href="tel:+989309428180" target="blank"><span class="lnr lnr-phone-handset"></span><span>Call</span></a></li>
                            <li><a href="mailto:smirzaie9287@gmail.com" target="blank"><span class="lnr lnr-envelope"></span><span>Email</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
