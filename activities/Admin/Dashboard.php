...
class Dashboard extends Admin{ 
        ...
        public function index()
        {
                ...
                $unseenComment = $db->select('SELECT COUNT(*) FROM comments WHERE status = "unseen"')->fetch();
                $approvedComment = $db->select('SELECT COUNT(*) FROM comments WHERE status = "approved"')->fetch();
